...
-- sql version - generate CREATE TABLE statement
-- TODO: add primary key to the table definition
SELECT                                          
...
(
  ...
  FROM pg_class c,
   pg_attribute a,
   pg_type t
   WHERE c.relname = 'test_temp_idname'
   AND a.attnum > 0
...
-- pl/pgsql version
-- adds schema names, type and null/not null statements
